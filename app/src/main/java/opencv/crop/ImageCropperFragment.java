...
import com.example.opencv_android.R;
...
import opencv.BaseFragment;
import opencv.util.CVProcessor;
...
public class ImageCropperFragment extends BaseFragment implements CropImageView.CropImageViewHost {
    ...
    private void initializeViews(View view) {
        ...
        if (Objects.requireNonNull(extras).containsKey(ARG_SRC_IMAGE_URI)) {
...
//        DrawableCompat.setTint(saveBtnDrawable, buttonTintColor);
    ...
    protected void onAfterViewCreated() {
        mRotateRight.setOnClickListener(view -> rotateRight());

        mRotateLeft.setOnClickListener(view -> rotateLeft());

        mSave.setOnClickListener(view -> cropAndSave());
    }
            ...
            public void onGlobalLayout() {
                ...
                if (imageUri != null) {
                    try {
                        ...
                        mBitmap = Util.loadBitmapFromUri(requireContext(), mScaleFactor, imageUri);
